export default function Home() {
  return (
    ...
    //     <h1 className="text-4xl md:text-5xl font-bold">Your All-in-One Tool</h1>
    //     <p className="text-lg mt-4 text-gray-400">
    //       AI-Powered Chatbot & Video Downloader
    //     </p>
    ...
    <main className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      <div className="max-w-4xl w-full text-center px-6 py-12">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <a
            href="/about"
            className="text-sm text-gray-500 hover:text-white mx-2"
          >
            About
          </a>
          <a
